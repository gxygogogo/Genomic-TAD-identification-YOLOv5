...
## 识别的工作流
![workflow](https://github.com/gxygogogo/Genomic-TAD-identification-YOLOv5/blob/main/img/workflow.png)
...
```
![result](https://github.com/gxygogogo/Genomic-TAD-identification-YOLOv5/blob/main/img/result.png)
